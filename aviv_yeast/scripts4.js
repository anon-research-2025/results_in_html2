...
function updateNav() {
    const currentPage = 'index4.html'; // Set this to the current page name
    const availablePages = createArray(3); // List of available page numbers
...
loadJSONData(() => {
    ...
    loadData(0, jsonData, initializeSliders);
});
